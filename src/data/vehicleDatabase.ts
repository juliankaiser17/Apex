...
export const APEX_LOCAL_VEHICLE_DATABASE: NormalizedVehicle[] = [
  ...
  },
  {
    ...
    originCountry: 'Italy',
    notableFacts: 'Facelift evolution of the Huracán featuring Y-shaped front bumper winglets, LDVI predictive vehicle dynamics, elevated dual sports exhaust, and integrated slotted rear spoiler.',
    baselineRarity: 'epic',
