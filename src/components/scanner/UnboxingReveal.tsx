    ...
    >
      ...
      {phase >= 6 && !showPostComposer && (
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center overflow-hidden">
          ...
          />
          {isMythic && (
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150vmax] h-[150vmax] rounded-full bg-[conic-gradient(from_0deg,transparent_0%,rgba(255,34,0,0.4)_30%,rgba(255,165,0,0.5)_50%,rgba(255,34,0,0.4)_70%,transparent_100%)] animate-[spin_2.5s_linear_infinite]" />
          )}
        </div>
      )}
